...
2. **Rust bridge** (`tauri-plugin-vpn/src/android.rs`, compiled only for Android) forwards to Kotlin. On other platforms the plugin registers nothing and the client uses `(0, 0)`.
