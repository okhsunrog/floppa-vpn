...
use crate::platform::{DnsSnapshot, Gateway, IpFamily, Platform, PlatformError, TunParams};
use crate::protocol::{InterfaceName, Protocol};
use crate::rollback::{Applied, Evidence, Journal, RollbackStack, StackId, Step};
use crate::state::{ProtocolConfig, SavedVpnConfigs, WgConfig};
...
async fn a_wipe_is_acknowledged_only_once_the_store_has_actually_been_wiped() {
    ...
    use crate::store::testing::{Gate, gated_persister};
