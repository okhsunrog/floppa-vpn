//! Reading a finished connect cycle as a statement about the peers on the server.
//!
//! Pure: it decides nothing about the network and talks to nobody. [`watcher`](crate::watcher) is
//! what acts on it.

use floppa_api_client::PeerProtocol;
use floppa_vpn_core::actor::types::{AttemptError, AttemptFailure, CycleOutcome};
