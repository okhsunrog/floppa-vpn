export default {
  ...
  settings: {
    ...
    diagnosticsDescription: 'Collect detailed logs to help troubleshoot connection issues.',
    diagnosticMode: 'Diagnostic mode',
    diagnosticModeDescription: 'Enable verbose logging for all components',
