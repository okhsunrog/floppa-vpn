...
/// the observation classified as [`World::Dark`](crate::vpn::actor::types::World) instead of
...
pub struct ServiceState {
    ...
    /// [`ServiceGenerations`](crate::vpn::autostart::ServiceGenerations), or the reserved
